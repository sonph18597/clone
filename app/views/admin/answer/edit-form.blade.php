...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">QuizQuiz-Admin</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html">Tối</a>
                                    <a class="nav-link" href="layout-sidenav-light.html">Sáng</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link" href="<?= BASE_URL . 'mon-hoc'?>">Chủ đề</a>
                                    <a class="nav-link" href="<?= BASE_URL . 'quiz'?>">Quiz</a>
                                    <a class="nav-link" href="<?= BASE_URL . 'question'?>">Question</a>
                                    <a class="nav-link" href="<?= BASE_URL . 'result_quiz'?>">Result Quiz</a>
                                </nav>
                            </div>
                        </div>
                    </div>
        ...
        <script src="./app/views/admin/assets/demo/chart-area-demo.js"></script>
        <script src="./app/views/admin/assets/demo/chart-bar-demo.js"></script>
