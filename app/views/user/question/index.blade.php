            ...
            <article class="">
                <form action="{{BASE_URL.'check_answer_QuizId'.$quiz->id}}" method="post" class="mx-3 my-1 rounded bg-light form1" id="form">   
                    ...
                    @foreach ($questions as $question)
                        ...
                        @endforeach
                        <input type="submit" name="submit" value="Nộp bài" class="btn btn-primary mx-4 my-4" id="submit">
                    </div>
                   
                    <div class="time my-4">
                        <!-- <h2><input type="number" id="time" value="{{ $quiz->duration_minutes}}"></h2> -->
                        <h2 id="time">{{ $quiz->duration_minutes}}:00</h2>
                    </div>
                    <h2 id="demo"></h2>
                </form>
...
window.onload = function () {
    var fiveMinutes = 60 * <?= $item->duration_minutes?>,
    // var fiveMinutes = 1 * 5,
